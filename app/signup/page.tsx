...
console.log(process.env.NEXT_PUBLIC_APIURL + '/student/register')
  ...
  return (
    <div className="min-h-screen  ">
      ...
      <div className="flex items-center justify-center min-h-screen pt-20 pb-12 px-4 md:px-0 bg-primary ">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-white mb-2">Join Loop Nest</h1>
