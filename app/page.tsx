...
Creative Design Mastery 
            ...
            <div className="relative animate-fade-in-right">
              <div className="relative">
                <Image
                  src="https://i.ibb.co.com/j9G2GRLb/Hero-Section.png"
          ...
          <div className="text-center mt-12">
            <Link href="/courses">
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-primary text-primary hover:bg-primary hover:text-white transition-colors duration-300"
              >
                View All Courses
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogPosts.map((post, index) => (
              <Card
                key={post.id}
                className={`group hover:shadow-lg transition-shadow duration-300 animate-fade-in-up animate-delay-${
                  index * 200
                } bg-[#11102794] border-gray-700 `}
              >
            ...
            <div className="text-white space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-xl text-gray-200">
                  Not sure which course is right for you? Our expert counselors
                  will help you choose the perfect learning path based on your
